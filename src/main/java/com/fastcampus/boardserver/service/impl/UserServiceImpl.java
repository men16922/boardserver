...
public class UserServiceImpl implements UserService {
    ...
    public void updatePassword(String id, String beforePassword, String afterPassword) {
        String encryptPassword = encryptSHA256(beforePassword);
        log.info("PASSWORD : {}", encryptPassword);
        UserDTO memberInfo = userProfileMapper.findByIdAndPassword(id, encryptPassword);
